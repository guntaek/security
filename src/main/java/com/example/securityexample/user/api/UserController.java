...
public class UserController {
    ...
    @PostMapping("/reissue")
    public ResponseEntity<?> reissue(@RequestBody JwtTokenDto jwtTokenDto) {
        return ResponseEntity.status(HttpStatus.CREATED).body(memberService.reissueToken(jwtTokenDto));
    }
}
